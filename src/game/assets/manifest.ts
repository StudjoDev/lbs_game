...
export const vfxProfiles: Record<string, VfxProfile> = {
  ...
  zuoci_five_talismans: {
    textureKey: "thunder_charm",
    color: 0xa8f5e6,
    blendMode: "add",
    scale: 0.94,
    lifetime: 0.42,
    particleKey: "particle_brackeys_magic",
    animationKeys: [brackeysElectricRingAnimationKey],
    nativeColor: true,
    telegraphShape: "burst",
    presentationKind: "areaField",
  ...
  guojia_musou_ice_star: musouVfxProfile("thunder_charm", 0xbdf7ff, "areaField", "burst", "cast", 1.2, 0.58, "particle_brackeys_spark", {
    animationKeys: [brackeysElectricRingAnimationKey],
    nativeColor: true
  }),
  luxun_musou_fireline: musouVfxProfile("red_cliff_fire", 0xff6332, "areaField", "storm", "cast", 1.26, 0.82, "particle_brackeys_fire", {
    animationKeys: [brackeysFireRingAnimationKey],
    nativeColor: true
  }),
