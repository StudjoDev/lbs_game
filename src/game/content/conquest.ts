...
export const conquestCities: ConquestCityDef[] = [
  ...
  city("xuchang", "許昌", "wei", "曹魏", "xiahoudun", "yellow_turbans", [], 2, 1),
  city("qiaojun", "譙郡", "wei", "曹魏", "xuchu", "yellow_turbans", ["xuchang"], 5, 1),
  city("hefei", "合肥", "wei", "曹魏", "zhangliao", "hulao_outer", ["qiaojun"], 10, 2),
  city("yecheng", "鄴城", "wei", "曹魏", "simayi", "red_cliff_line", ["hefei"], 16, 3),
  city("jianye", "建業", "wu", "江東", "zhouyu", "yellow_turbans", [], 2, 1),
  city("wujun", "吳郡", "wu", "江東", "sunshangxiang", "yellow_turbans", ["jianye"], 5, 1),
  city("jinfan_camp", "錦帆水寨", "wu", "江東", "ganning", "hulao_outer", ["wujun"], 10, 2),
  city("shenting", "神亭", "wu", "江東", "taishici", "red_cliff_line", ["jinfan_camp"], 16, 3),
  city("julu", "巨鹿", "qun", "群雄", "zhangjiao", "yellow_turbans", [], 2, 1),
  city("guandu", "官渡", "qun", "群雄", "yuanshao", "hulao_outer", ["julu"], 9, 2),
  city("qingnang_valley", "青囊谷", "qun", "群雄", "huatuo", "red_cliff_line", ["guandu"], 15, 3),
  city("luoyang", "洛陽", "final", "終局", "dongzhuo", "red_cliff_line", ["longzhong", "yecheng", "shenting", "qingnang_valley"], 22, 4)
];
